...
%! 'm*n_generate'(?M:nonneg, ?N:nonneg, +Counter:nonneg, :Dcg)// .
%! 'm*n_generate'(?M:nonneg, ?N:nonneg, +Counter:nonneg, :Dcg, -Args1:list, ...)// .
...
%! 'm*n_parse'(?M:nonneg, ?N:nonneg, +Counter:nonneg, :Dcg)// .
%! 'm*n_parse'(?M:nonneg, ?N:nonneg, +Counter:nonneg, :Dcg, -Args1:list, ...)// .
